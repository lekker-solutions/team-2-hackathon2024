...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" TypeName="PX.Objects.AM.ProdDetail" PrimaryView="ProdItemRecords" Visible="True" BorderStyle="NotSet" HeaderDescriptionField="Descr">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand CommitChanges="True" Name="ItemLineSplittingExtension_GenerateNumbers" Visible="False" />
            <px:PXDSCallbackCommand CommitChanges="True" Name="ItemLineSplittingExtension_ShowSplits" Visible="False" />
            <px:PXDSCallbackCommand CommitChanges="True" Name="MatlLineSplittingExtension_GenerateNumbers" Visible="False" />
            <px:PXDSCallbackCommand CommitChanges="True" Name="MatlLineSplittingExtension_ShowSplits" Visible="False" DependOnGrid="gridMatl" />
            ...
            <px:PXDSCallbackCommand Name="CreateVendorShipment" Visible="False" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
...
<Template1>
    <px:PXGrid ID="gridOperations" runat="server" DataSourceID="ds" Width="100%" Height="100%" SkinID="Details" Caption="Operations" SyncPosition="true" >
        <Levels>
            <px:PXGridLevel DataKeyNames="ProdOrdID,OperationID" DataMember="ProdOperRecords">
                <RowTemplate>
                    ...
                    <px:PXDateTimeEdit ID="edActStartDate" runat="server" DataField="ActStartDate_Date" />
                    <px:PXDateTimeEdit ID="edActEndDate" runat="server" DataField="ActEndDate_Date" />
                    <px:PXDropDown ID="edScrapAction" runat="server" DataField="ScrapAction" />
                    <px:PXCheckBox ID="edOperOutsideProcess" runat="server" DataField="OutsideProcess" CommitChanges="True" />
                    <px:PXCheckBox ID="edOperDropShippedToVendor" runat="server" DataField="DropShippedToVendor" />
                    <px:PXSegmentMask ID="edOperVendorID" runat="server" DataField="VendorID" CommitChanges="True" />
                    <px:PXSegmentMask ID="edOperVendorLocationID" runat="server" DataField="VendorLocationID" AutoRefresh="True" />
                    <px:PXTextEdit ID="edOperPOOrderNbr" runat="server" DataField="POOrderNbr" />
                    <px:PXNumberEdit ID="edOperPOLineNbr" runat="server" DataField="POLineNbr"/>
                    <px:PXNumberEdit ID="edOPerShippedQuantity" runat="server" DataField="ShippedQuantity" Width="150px" />
                    <px:PXNumberEdit ID="edOPerShipRemainingQty" runat="server" DataField="ShipRemainingQty" Width="150px" />
                    <px:PXNumberEdit ID="edOPerAtVendorQuantity" runat="server" DataField="AtVendorQuantity" Width="150px" />
                    <px:PXCheckBox ID="edOPerControlPoint" runat="server" DataField="ControlPoint" Width="150px" />
                </RowTemplate>
                <Columns>
                    ...
                    <px:PXGridColumn DataField="SetupTimeRaw" Visible="False" AllowShowHide="False" />
                    ...
                    <px:PXGridColumn DataField="RunUnitTimeRaw" Visible="False" AllowShowHide="False" />
                    ...
                    <px:PXGridColumn DataField="MachineUnitTimeRaw" Visible="False" AllowShowHide="False" />
                    <px:PXGridColumn DataField="QueueTime" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn DataField="QueueTimeRaw" Visible="False" AllowShowHide="False" />
                    <px:PXGridColumn DataField="FinishTime" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn DataField="FinishTimeRaw" Visible="False" AllowShowHide="False" />
                    <px:PXGridColumn DataField="MoveTime" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn DataField="MoveTimeRaw" Visible="False" AllowShowHide="False" />
                    ...
                    <px:PXGridColumn DataField="OutsideProcess" TextAlign="Center" Type="CheckBox" AutoCallBack="True" Visible="False" AllowShowHide="False" />
                    <px:PXGridColumn DataField="DropShippedToVendor" TextAlign="Center" Type="CheckBox" AutoCallBack="True" Visible="False" AllowShowHide="False" />
                    <px:PXGridColumn DataField="VendorID" AutoCallBack="True" Visible="False" AllowShowHide="False" TextAlign="Left" />
                    <px:PXGridColumn DataField="VendorLocationID" AutoCallBack="True" Visible="False" AllowShowHide="False" TextAlign="Left" />
                    <px:PXGridColumn DataField="POOrderNbr" Visible="False" AllowShowHide="False" />
                    <px:PXGridColumn DataField="POLineNbr" Visible="False" AllowShowHide="False" />
                    <px:PXGridColumn DataField="ShippedQuantity" Visible="False" AllowShowHide="False" />
                    <px:PXGridColumn DataField="ShipRemainingQty" Visible="False" AllowShowHide="False" />
                    <px:PXGridColumn DataField="AtVendorQuantity" Visible="False" AllowShowHide="False" />
                    <px:PXGridColumn DataField="ControlPoint" Type="CheckBox" TextAlign="Center" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
        ...
        <AutoCallBack Command="Refresh" Target="gridmatl" ActiveBehavior="true">
            <Behavior RepaintControlsIDs="tab,gridmatl,gridStep,gridTool,gridOvhd,totalsform,outsideProcessingform" />    
        </AutoCallBack>
        <ActionBar ActionsText="False" >
            <CustomItems>
                <px:PXToolBarButton DependOnGrid="gridOperations" >
                    <AutoCallBack Command="CreatePurchaseOrder" Target="ds" />
                </px:PXToolBarButton>
                <px:PXToolBarButton DependOnGrid="gridOperations" StateColumn="OutsideProcess" >
                    <AutoCallBack Command="CreateVendorShipment" Target="ds" />
                </px:PXToolBarButton>
            </CustomItems>
        </ActionBar>
    </px:PXGrid>
        ...
        <px:PXGrid ID="gridMatl" runat="server" DataSourceID="ds" Width="100%" SkinID="DetailsInTab" SyncPosition="True" TabIndex="2600" StatusField="Availability" >
            <Levels>
                <px:PXGridLevel DataKeyNames="ProdOrdID,OperationID,LineID" DataMember="ProdMatlRecords">
                    <RowTemplate>
                        ...
                        <px:PXCheckBox CommitChanges="True" ID="edPOCreate" runat="server" DataField="POCreate"/>
                        ...
                        <px:PXDropDown ID="edMatlStatus" runat="server" DataField="StatusID" />
                    </RowTemplate>
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="StatusID" Width="100px" />
            ...
            <ActionBar ActionsText="False">
                <CustomItems>
                    ...
                    <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="MatlLineSplittingExtension_ShowSplits" CommandSourceID="ds" 
            ...
            <Levels>
                <px:PXGridLevel DataKeyNames="ProdOrdID,OperationID,LineID" DataMember="ProdOvhdRecords">
                    <RowTemplate>
                        ...
                        <px:PXNumberEdit ID="edAMOverhead__CostRate" runat="server" DataField="AMOverheadCurySettings__CostRate"  />
                    ...
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="AMOverheadCurySettings__CostRate" TextAlign="Right" Width="117px" />
    ...
    <Template >
        <px:PXFormView ID="totalsform" runat="server" CaptionVisible="False" DataMember="ProdOperSelected" DataSourceID="ds" SkinID="Transparent" Width="100%" >
            <Template>
                ...
                <px:PXNumberEdit ID="edPlanLaborTimeRaw" runat="server" DataField="PlanLaborTimeRaw" Visible="False" />
                ...
                <px:PXNumberEdit ID="edActualLaborTimeRaw" runat="server" DataField="ActualLaborTimeRaw" Width="150px" Visible="False" />
                ...
                <px:PXNumberEdit ID="edVarianceLaborTimeRaw" runat="server" DataField="VarianceLaborTimeRaw" Width="150px" Visible="False" />
...
<AutoSize Enabled="True" />
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Width="90%" Height="360px" Caption="Line Details" CaptionVisible="True" Key="MatlLineSplittingExtension_lsselect"
        AutoCallBack-Command="Refresh" AutoCallBack-Target="optform" DesignView="Content" TabIndex="3200">
        <px:PXFormView ID="optform" runat="server" CaptionVisible="False" DataMember="MatlLineSplittingExtension_LotSerOptions" DataSourceID="ds" SkinID="Transparent"
            ...
            <Template>
                ...
                <px:PXButton ID="btnGenerate" runat="server" CommandName="MatlLineSplittingExtension_GenerateNumbers" CommandSourceID="ds" Height="20px"
                    Text="Generate" />
            </Template>
            <Parameters>
    ...
    <px:PXSmartPanel ID="PanelPOSupply" runat="server" Width="960px" Height="360px" Caption="Purchasing Details" CaptionVisible="True"
        ...
        <px:PXFormView ID="formCurrentPOSupply" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="currentposupply"
            ...
            <Template>
                ...
                <px:PXSegmentMask CommitChanges="True" ID="PXSegmentMask1" runat="server" DataField="VendorID" AutoRefresh="True" />
