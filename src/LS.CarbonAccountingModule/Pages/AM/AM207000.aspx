    ...
    <px:PXTab ID="tab" runat="server" Width="100%">
		<Items>
            <px:PXTabItem Text="General">
                <Template>   
                    <px:PXFormView ID="FormGeneral" runat="server" DataMember="WCRecordsSelected" DataSourceID="ds" Width="100%">
                        <Template>
                            <px:PXLayoutRule runat="server" StartColumn="True"  LabelsWidth="M" ControlSize="XM" />
                            
                            <px:PXFormView ID="curySettingsForm" runat="server" SkinID="Inside" RenderStyle="simple" DataSourceID="ds" DataMember="CurySettings_AMWC" CaptionVisible="false">
                                <Template>
                            ...
                            <px:PXCheckBox ID="chkAllowMult" runat="server" DataField="AllowMultiClockEntry" />
                            <px:PXCheckBox ID="chkControlPoint" runat="server" DataField="ControlPoint" />
                            ...
                            <px:PXLayoutRule runat="server" StartColumn="True"  LabelsWidth="M" ControlSize="M" />
                            <px:PXMaskEdit ID="edDefaultQueueTime" runat="server" DataField="DefaultQueueTime" />
                            <px:PXMaskEdit ID="edDefaultFinishTime" runat="server" DataField="DefaultFinishTime" />
			...
			<px:PXTabItem Text="Shifts">
                <Template>
                    <px:PXGrid ID="grid" runat="server" AdjustPageSize="Auto" AllowPaging="True" AllowSearch="true" 
                        ...
                        <Levels>
                            <px:PXGridLevel DataKeyNames="ShiftCD,WcID" DataMember="WCShifts">
                                <RowTemplate>
                                    <px:PXSelector ID="edShiftCD" runat="server" DataField="ShiftCD" MaxLength="15"  />
                                    ...
                                    <px:PXDropDown ID="edDiffType" runat="server" DataField="EPShiftCode__DiffType" />
                                    <px:PXNumberEdit ID="edShftDiff" runat="server" DataField="EPShiftCode__ShftDiff" />
                                    <px:PXSelector ID="edLaborCodeID" runat="server" DataField="LaborCodeID" AllowEdit="True"/>
                                    <px:PXTextEdit ID="PXTextEdit1" runat="server" Visible="false" AllowNull="False" DataField="WcID"  MaxLength="10" />
                                </RowTemplate>
                                <Columns>
                                    <px:PXGridColumn DataField="ShiftCD" />
                                    ...
                                    <px:PXGridColumn AllowUpdate="False" DataField="EPShiftCode__DiffType" Label="Diff Type" MaxLength="1" RenderEditorText="True" Width="80px" />
                                    <px:PXGridColumn AllowUpdate="False" DataField="EPShiftCode__ShftDiff" Label="Differential" TextAlign="Right" Width="117px" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataKeyNames="WcID,MachID" DataMember="WCMachines">
                                <RowTemplate>
                                    ...
                                    <px:PXNumberEdit ID="PXNumberEdit1" runat="server" DataField="StdCost"  />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="WCWhereUsed" DataKeyNames="BOMID,OperationID">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ControlPoint" TextAlign="Center" Type="CheckBox" />
                                    ...
                                    <px:PXGridColumn DataField="FinishTime" TextAlign="Right" Width="99px" />
                                    <px:PXGridColumn DataField="MoveTime" TextAlign="Right" Width="99px" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                    <ActionBar>
                    ...
                    <px:PXGrid ID="gridSubstituteWorkCenters" runat="server" AllowPaging="True" SyncPosition="True" 
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="SubstituteWorkCenters">
                                <RowTemplate>
                                    <px:PXLayoutRule runat="server" StartColumn="True"  LabelsWidth="M" ControlSize="XM" />
                                    <px:PXSelector ID="PXSelector1" runat="server" DataField="SiteID" AllowEdit="True" />
