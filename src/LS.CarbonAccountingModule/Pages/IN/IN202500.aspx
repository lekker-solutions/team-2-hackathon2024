        ...
        <Items>
            <px:PXTabItem Text="General">
                <Template>
                    ...
                    <px:PXNumberEdit ID="edCarbonEmission" runat="server" DataField="CarbonEmission" Enabled="true" />
            ...
            <px:PXTabItem Text="Price/Cost">
                <Template>
                    ...
                    <px:PXFormView ID="formRUTROTItemSettings" runat="server" Width="100%" DataMember="RUTROTItemSettings" DataSourceID="ds" Caption="Rules" SkinID="Transparent">
                        <Template>
                            <px:PXLayoutRule runat="server" ID="PXLayoutRuleC1" StartGroup="true" GroupCaption="RUT and ROT Settings" ControlSize="XM" />
			...
			<px:PXTabItem Text="Manufacturing" RepaintOnDemand="False">
				<Template>
					...
					<px:PXLayoutRule runat="server" ID="PXLayoutRule1" LabelsWidth="S" ControlSize="XM" />
            ...
            <px:PXTabItem Text="Attributes">
                <Template>
                    ...
                    <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="XM" />
                    <px:PXImageUploader Height="320px" Width="430px" ID="imgUploader" runat="server" DataField="ImageUrl" AllowUpload="true" AllowNoImage="true" ShowComment="true" DataMember="ItemSettings"
						 />
                </Template>
            </px:PXTabItem>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="itemxrefrecords" DataKeyNames="InventoryID,SubItemID,AlternateType,BAccountID,AlternateID">
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXTextEdit ID="PXTextEdit1" runat="server" DataField="Descr" />
                                </RowTemplate>
                                <Layout FormViewHeight="" />
                            </px:PXGridLevel>
                        </Levels>
            ...
            <px:PXTabItem Text="Inventory Planning" RepaintOnDemand="False" LoadOnDemand="True">
                <Template>
                    <px:PXSplitContainer runat="server" ID="sp1" SplitterPosition="600" SkinID="Horizontal" Height="800px">
                        <AutoSize Enabled="true" />
                        <Template1>
                            <px:PXFormView runat="server" ID="inventoryPlanningSettingsForm" DataMember="inventoryPlanningSettings">
                                <Template>
                                    <px:PXLayoutRule runat="server" GroupCaption="Inventory Planning Settings" StartColumn="True" LabelsWidth="SM" ControlSize="XM" />
                                    <px:PXLayoutRule runat="server" />
                            ...
                            <px:PXFormView runat="server" RenderStyle="Simple" ID="frmProductionDefaults" DataMember="productionOrderDefaultSettings" AllowCollapse="True">
                                <Template>
                                    ...
                                    <px:PXSegmentMask CommitChanges="True" ID="PXSegmentMask1" runat="server" DataField="AMSourceSiteID" AllowEdit="true" />
                                    <px:PXNumberEdit runat="server" ID="PXNumberEdit1" DataField="AMMinOrdQty" />
                                    <px:PXNumberEdit runat="server" ID="PXNumberEdit2" DataField="AMMaxOrdQty" />
                                    <px:PXNumberEdit runat="server" ID="PXNumberEdit3" DataField="AMLotSize" />
                                    <px:PXNumberEdit runat="server" ID="PXNumberEdit4" DataField="AMMFGLeadTime" />
                                </Template>
                            </px:PXFormView>
                                ...
                                <Levels>
                                    <px:PXGridLevel DataMember="replenishment" DataKeyNames="InventoryID,ReplenishmentClassID">
                                        <RowTemplate>
                                            ...
                                            <px:PXDropDown ID="PXDropDown1" runat="server" DataField="ReplenishmentSource" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Components" DataKeyNames="InventoryID,ComponentID">
                                <RowTemplate>
									...
									<px:PXNumberEdit runat="server" ID="PXNumberEdit5" DataField="DefaultTerm" CommitChanges="true" />
            ...
            <px:PXTabItem Text="GL Accounts">
                <Template>
                    ...
                    <px:PXSegmentMask ID="PXSegmentMask2" runat="server" DataField="SalesAcctID" CommitChanges="true" />
                    <px:PXSegmentMask ID="PXSegmentMask3" runat="server" DataField="SalesSubID" AutoRefresh="True" />
				...
				<Template>
					<px:PXFormView runat="server" ID="formSM" DataMember="ItemSettings" Style="z-index: 100" Width="100%">
						...
						<Template>
							...
							<px:PXLayoutRule runat="server" Merge="True" />
							<px:PXNumberEdit runat="server" ID="edCpnyWarrantyValue" DataField="CompanyWarrantyValue" Width="30px" />
							<px:PXDropDown runat="server" ID="edCpnyWarrantyType" DataField="CompanyWarrantyType" SuppressLabel="True" Size="S" />
							<px:PXLayoutRule runat="server" Merge="True" />
